...
Host User ID for permission mapping.
...
Host Group ID for permission mapping.
...
The external port exposed for the web interface.
...
Host timezone. Critical for accurate scheduler execution.
...
Sets backend verbosity (INFO or DEBUG).
...
Absolute path to the host directory targeted for scanning.
